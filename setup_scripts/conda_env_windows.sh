...
conda create -n $1 -c conda-forge python=3.6.8 cartopy shapely tqdm geographiclib cython h5py mpi4py==3.0.3 netCDF4==1.4.0 pyproj==3.0.1 scipy scikit-learn==0.22.2.post1 rtree==0.9.7 PyWavelets==1.1.1 matplotlib==3.3.4 pandas==1.1.5 opencv==4.5.3
