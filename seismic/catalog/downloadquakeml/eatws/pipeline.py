...
from eatws.acquire_data import acquire_native_eatws_data
from eatws.format_data import save_eatws_data_to_quakeml


def download_eatws_event_data(start_time, end_time, output_directory):

    events_data = acquire_native_eatws_data(start_time, end_time)
