...
asdfDataSet = pyasdf.ASDFDataSet('/g/data/ha3/Passive/_ANU/7D(2012-2013)/ASDF/7D(2012-2013).h5', mode='r')
...
def custom_get_waveforms(network, station, location, channel, starttime,
    ...
    filteredList = [i for i in asdfDataSet.waveforms[network+'.'+station].list() if 'raw_recording' in i and UTC(i.split("__")[1]) < starttime and UTC(i.split("__")[2]) > endtime]
