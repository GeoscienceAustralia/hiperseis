...
dirwrk = fullfile('/Users','nita','GEOPHYSICS', 'YOULIN', 'Sta_Files'); 
% reg = 'Reg_CenterChina';
% reg = 'Reg_EastChina';
% reg = 'Reg_NorthEast';
% reg = 'Reg_NorthChina';
...
dirsacs = fullfile('/Users','nita','GEOPHYSICS','YOULIN','SEISMOGRAMS', reg, netcode, netcode, stacode, psdir, gausdir)
ascf = ['sfr2d.', netcode, '.', stacode, '.x0'];
sumf = ['hkr2d.', netcode, '.', stacode,'.x0.03'];
% ascf = ['sfr2d.b90x7.', stacode];
% sumf = ['hkr2d.b90x7.', stacode,'.00'];
nmfactor = 0.8;     % 0.5 or 0.8

%---- H-k summary file -----------------
file_sum = fullfile(dirwrk, netcode, stacode,psdir, vpdir, bazdir, sumf)
...
file_sfun = fullfile(dirwrk, netcode, stacode, psdir, vpdir, bazdir, ascf);
